...
This folder defines all source code for the 'BTS Pipelines (ms)' pipeline:
...
* Take a look at the sample under "sample_users_bts_pipelines_ms.py" to get familiar with the syntax.
